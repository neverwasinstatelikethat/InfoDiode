...
| Видео | Описание |
|-------|----------|
| **quick_demo** | Быстрая демонстрация работы фронтенда — загрузка видео, запуск пайплайна, просмотр результатов, скачивание видео с QR-кодом |
| **processed_video_with_qr_overlay** | Обработанное видео с наложенным QR-кодом, который ведёт на JSON с параметрами, извлечёнными на данном отрезке времени |
