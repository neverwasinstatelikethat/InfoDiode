...
<div class="min-h-screen flex items-center justify-center bg-base p-4 relative overflow-hidden">
	...
	<div class="relative w-full max-w-sm animate-scale-in">
		...
		<div class="text-center mb-8">
			...
			<p class="text-text-tertiary text-sm">Войдите, чтобы начать работу</p>
		</div>
		...
		<div class="bg-elevated border border-border rounded-xl p-6 shadow-2xl shadow-black/30">
			...
			<div class="mt-5 text-center">
				<a href="/auth/register" class="text-sm text-accent hover:text-accent-hover transition-colors duration-200">
					Создать аккаунт
				</a>
			</div>
		</div>
		...
		<div class="mt-4 text-center">
			<p class="text-xs text-text-tertiary">По умолчанию: admin / admin</p>
		</div>
	</div>
</div>
